...
const Finishhost = () => {
    ...
    const finish = ['Title', 'Rooms', 'Location', 'Amenities', 'Photos', 'Description', 'Profile Photo', 'Check in and Check out', 'Agreement', 'Calendar Availability', 'Pricing',]
        ...
        <div>
            ...
            <div class="container px-4 text-center">
                <div class="row gx-5 p-5">
                    <div class="col p-2">
                        <div class="p-3 border bg-light p-2">
